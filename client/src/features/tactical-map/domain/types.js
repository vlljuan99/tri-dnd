 ...
 * @typedef {{ id: string, campaignId: number | string, name: string, width: number, height: number, gridSize: number, backgroundUrl?: string, tokens: TacticalToken[] }} TacticalMap
