...
import { campaignArchiveRouter } from './routes/campaignArchive.js';
...
app.use('/api/plantillas', templatesRouter);
app.use('/api/eventos', eventsRouter);
app.use('/api/sonidos', soundsRouter);
app.use('/api/characters', charactersRouter);
app.use('/api/campaigns/:campaignId/archivo', campaignArchiveRouter);
